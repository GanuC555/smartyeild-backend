...
export declare class UserService {
    ...
    constructor(userModel: Model<User>, positionModel: Model<Position>, transactionModel: Model<Transaction>, lanePositionModel: Model<LanePosition>, market: MarketSimulatorService);
