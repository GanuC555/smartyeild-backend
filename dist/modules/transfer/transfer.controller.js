...
let TransferController = class TransferController {
    ...
    send(body, req) {
        return this.transferService.sendP2P(req.user.sub, body.toAddress, body.amount, body.note);
    }
    getHistory(req) {
...
], TransferController.prototype, "getBalance", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], TransferController.prototype, "send", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], TransferController.prototype, "getHistory", null);
